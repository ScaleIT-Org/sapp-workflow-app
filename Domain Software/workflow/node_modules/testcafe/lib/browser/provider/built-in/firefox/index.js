                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            ...
                            _context6.next = 3;
                            return _this6.resizeWindow(browserId, maximumSize.width, maximumSize.height);
            ...
            return _regenerator2.default.wrap(function _callee7$(_context7) {
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            _openedBrowsers$brows = _this7.openedBrowsers[browserId], config = _openedBrowsers$brows.config, marionetteClient = _openedBrowsers$brows.marionetteClient;
